...
const handleCancel =()=>{
  ...
  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
    ...
    <div className="flex items-center gap-2 mt-1" >{isEditing ?(
      ...
      <>
       <CardDescription>
        ...
        {typeof currentExpenses === "number" && typeof initialBudget?.amount === "number"
  ...
  <Progress value={percentUsed} extraStyles={`${
    percentUsed >= 90 
    ? "bg-red-500"
    : percentUsed >= 75
    ? "bg-yellow-500"
